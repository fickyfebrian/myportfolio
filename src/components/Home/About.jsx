...
const About = () => (
  <section
    id="about"
    className="mt-20 max-w-7xl mx-auto px-6 md:px-12 py-12 md:py-20  "
  >
    {/* Section Title */}
    ...
    <p className="text-xl text-center mt-4 mb-12 font-roboto text-black">
      In this section, you'll find more details about my background,
      professional experience, and technical skills in web development and
      technology.
    </p>
    ...
    <div className="grid md:grid-cols-2 gap-10">
      ...
      <div>
        ...
        <p className="text-xl text-justify text-black mb-6 font-roboto">
          I am a 5th-semester student majoring in Informatics Engineering at
          Universitas Sangga Buana YPKP Bandung. I'm passionate about front-end
          development and proficient in HTML, CSS, JavaScript, and React.js.
          I've worked on a team project called SIM-Skripsi and have experience
          with PHP and Laravel. I'm eager to develop my skills through work
